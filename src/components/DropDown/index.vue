<template>
  <nav class="navbar navbar-dark bg-primary justify-content-between mb-4 px-4">
    <router-link class="navbar-brand" to="/">DropDown组件</router-link>
    ...
    <ul v-else class="list-inline mb-0">
      ...
      <li class="list-inline-item">
        <dropdown :title="`你好 ${user.name}`">
          <!-- dropdown插槽 -->
          <dropdown-item><!-- dropdown-item插槽 --><router-link to="/create" class="dropdown-item">新建文章</router-link></dropdown-item>
          <dropdown-item><router-link :to="`/column/${user.id}`" class="dropdown-item">我的专栏</router-link></dropdown-item>
